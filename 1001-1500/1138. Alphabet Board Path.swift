class Solution {
    ...
    func alphabetBoardPath(_ target: String) -> String {
        let boardArray = ["abcde", "fghij", "klmno", "pqrst", "uvwxy", "z"].map {
        ...
        while queue.isEmpty == false {
            ...
            for neighbor in [(-1, 0, "U"), (0, 1, "R"), (1, 0, "D"), (0, -1, "L")] {
                ...
                if newRow < boardArray.count && newRow >= 0 && newCol < boardArray[newRow].count
                    && newCol >= 0 && !visitedSet.contains(boardArray[newRow][newCol])
                {
