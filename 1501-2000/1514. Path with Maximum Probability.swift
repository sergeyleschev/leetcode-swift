class Solution {
    ...
    func maxProbability(_ n: Int, _ edges: [[Int]], _ succProb: [Double], _ start: Int, _ end: Int)
        -> Double
    {
    ...
    func maxProbability_fail(
        _ n: Int, _ edges: [[Int]], _ succProb: [Double], _ start: Int, _ end: Int
    ) -> Double {
    ...
    func dfs(
        _ vertex: Int, _ n: Int, _ edges: [[Int]], _ succProb: [Double], _ end: Int, _ last: Double
    ) -> Double {
        var prob: Double = 0
