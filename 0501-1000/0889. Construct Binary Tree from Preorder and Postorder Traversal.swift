...
class Solution {
    ...
    func constructFromPrePost(_ pre: [Int], _ post: [Int]) -> TreeNode? {
        constructFromPrePost(pre, post, 0, 0, pre.count)
    }

    func constructFromPrePost(
        _ pre: [Int], _ post: [Int], _ preStart: Int, _ postStart: Int, _ count: Int
    ) -> TreeNode? {
        ...
        root.right = constructFromPrePost(
            pre, post, preStart + splitIndex + 1, postStart + splitIndex, count - splitIndex - 1)
        return root
    }
